...
@push('header')
  <script type="application/ld+json">
    {!! json_encode([
      ...
      "@type" => "Article",
      "headline" => $page->description->title,
      "author" => [
        "@type" => "Person",
        "name" => $page->author,
      ],
      ...
      "publisher" => [
        "@type" => "Organization",
        "name" => system_setting('base.site_name'),
        "logo" => [
          "@type" => "ImageObject",
          "url" => asset('image/logo.png'),
        ],
      ],
      "image" => isset($page->images) && is_array($page->images) ? array_column($page->images, 'preview') : ($page->image ?? ''),
      "description" => $page->description->meta_description ?: $page->description->summary,
