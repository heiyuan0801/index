...
@push('header')
  <script type="application/ld+json">
    {!! json_encode([
      ...
      "@type" => "Product",
      "name" => $product['name'],
      "image" => isset($product['images']) && is_array($product['images']) ? array_column($product['images'], 'preview') : '',
  ...
  @php file_put_contents(storage_path('logs/schema_blade.log'), 'blade-called:'.date('Y-m-d H:i:s').PHP_EOL, FILE_APPEND); @endphp
  @hook('theme.product.schema', [
    'name' => $product['name'],
